<script setup>
import { useRujukanBatamStore } from '../../../stores/rujukan/batam.js';

const store = useRujukanBatamStore();
...
<template>
    <div class="px-12 h-auto w-full py-8">
        ...
        <RujukanBatamCreate :show="showCreate" @close="showCreate = false" />
        <RujukanBatamEdit :show="showEdit" :data="itemData" @close="showEdit = false" />
        <RujukanBatamRemove :show="showRemove" :data="selected" @close="showRemove = false" />
    </div>
</template>