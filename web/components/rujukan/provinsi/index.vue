...
<template>
    <div class="px-12 h-auto w-full py-8">
        ...
        <RujukanProvinsiCreate :show="showCreate" @close="showCreate = false" />
        <RujukanProvinsiEdit :show="showEdit" :data="itemData" @close="showEdit = false" />
        <RujukanProvinsiRemove :show="showRemove" :data="selected" @close="showRemove = false" />
    </div>
</template>